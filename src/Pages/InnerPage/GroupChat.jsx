...
const GroupStayHut = () => {
  ...
  const images = [
    "/images/all/Villa bath night 2.jpg",
    "/images/all/Villa entrance.jpg",
    "/images/all/Villa bathroom night.jpg",
    "/images/all/k 32481.jpg",
  ];
  ...
  return (
    <section className="">
      <BreadCrumb title="Group Stay Hut" />
          ...
          <div className="col-span-6 md:col-span-4">
            ...
            <div className="pt-5 lg:pt-[35px]  pr-3">
              ...
              <p
                ...
                data-aos-duration="1000"
              >
                Togetherness in the Thar — without compromising comfort. <br />
                Built for community, connection, and ease, our Group Stay Huts
                are a wonderful option for friends, backpackers, or retreat
                groups looking to share space without sacrificing tranquility.
                These shared-style accommodations are designed to balance social
                warmth with restful privacy. Each hut features multiple beds or
                sleeping zones, ample space for luggage, and windows that bring
                in the desert light. Rustic on the outside and simple yet
                comfortable inside, these huts encourage bonding, stories, and
                slow mornings with chai. Perfect for group travel, yoga
                retreats, art residencies, or those simply looking to meet
                fellow wanderers.
              </p>
              <p
              ...
              >
                ...
                <li>Multiple single or queen beds (based on group size)</li>

                <li>Shared yet spacious layout</li>

                <li>Desert-view windows and natural ventilation</li>

                <li>Private bathroom with western fittings</li>

                <li>
                  Common sit-out or porch areaCommon sit-out or porch area
                </li>

                <li>Access to bonfire evenings and group activities</li>

                <li>
                  Great for budget travelers, friends, or retreat organizers
                </li>
              </p>
